 ...
 <!--Main Menu HTML Code-->
      <nav class="wsmenu clearfix" style="overflow-y: auto;">
          <div class="logo clearfix col-sm-2"><a href="index.php" title="Responsive Slide Menus"><img src="images/logob.png" class="img-responsive" alt="nerdcomhost"></a></div>
                    <ul class="mobile-sub wsmenu-list">
                      ...
                      <li class="menu-arrow-1"><span class="wsmenu-click"><i class="wsmenu-arrow fa fa-angle-down"></i></span><a href="#"><i class="fa fa-cogs"></i>&nbsp;&nbsp;Panel</a>
                        </li>
